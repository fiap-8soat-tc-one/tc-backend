package com.fiap.tc.exception.handler;
...
import com.fiap.tc.exception.BadRequestException;
import com.fiap.tc.exception.IntegracaoException;
...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = { BadRequestException.class, IllegalStateException.class, IllegalArgumentException.class,
			NoSuchElementException.class, IntegracaoException.class })
