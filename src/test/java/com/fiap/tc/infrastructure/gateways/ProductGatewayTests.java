...
public class ProductGatewayTests extends FixtureTest {
    ...
    public void listProductsByCategoryTest() {
        ...
        var productsPageable = productGateway.list(CATEGORY_ID, pageable);
    ...
    public void loadProductTest() {
        ...
        var productResult = productGateway.load(PRODUCT_ID);
    ...
    public void launchExceptionOnLoadProductWhenProductNotExistsTest() {
        ...
        var assertThrows = Assertions.assertThrows(NotFoundException.class,
                () -> productGateway.load(PRODUCT_ID));
    ...
    public void saveProductOnRegisterProductTest() {
        ...
        var productResult = productGateway.register(product);
    ...
    public void updateProductTest() {
        ...
        var productResult = productGateway.update(product);
    ...
    public void launchExceptionOnSaveProductWhenCategoryNotExistsTest() {
        ...
        var assertThrows = Assertions.assertThrows(NotFoundException.class,
                () -> productGateway.register(product));
